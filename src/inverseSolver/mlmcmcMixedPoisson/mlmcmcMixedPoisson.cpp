...
int main(int argc, char* argv[])
{
	...
	// PetscOptionsSetValue(NULL, "-fieldsplit_0_pc_type", "cholesky");
	...
	switch (confData.task){
        ...
        case 2: //MLMCMC estimation
        {
            ...
            if (confData.parallelChain == 1){
                ...
                MLMCMC_Bi<pCN<elasticMixed2dSolver>, elasticMixed2dSolver> MLMCMCSolver(PETSC_COMM_SELF, confData.levels, confData.num_term, rank*confData.randomSeed/2, confData.a, confData.noiseVariance, confData.randomSeed, confData.pCNstep);
                output = MLMCMCSolver.mlmcmcRun();
                std::cout << output << std::endl;
