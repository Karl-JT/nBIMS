...
void NSE2dSolver::SetupProblem(DM dm, AppCtx *ctx)
{
    PetscDS           ds;
    DMLabel           label;
    const PetscInt    id=1;
    ...
    DMAddBoundary(dm, DM_BC_ESSENTIAL, "wall", label, 1, &id, 0, 0, NULL, (void (*)(void)) u_2d, NULL, ctx, NULL);
}
