...
int main(int argc, char* argv[])
{
	...
	switch (confData.task){
        ...
        {
            NSE2dSolverIC singleForwardSolver(PETSC_COMM_SELF, confData.levels, confData.num_term,confData.noiseVariance);
            singleForwardSolver.samples[0]=0.8;
            singleForwardSolver.samples[1]=-0.8;
        ...
        case 2: //MLMCMC estimation
        {
            ...
            if (confData.parallelChain == 1){
                ...
                MLMCMC_Bi_Uniform<pCN<NSE2dSolverIC>, NSE2dSolverIC> MLMCMCSolver(PSubComm, confData.levels, 1, color, confData.a, confData.noiseVariance, confData.randomSeed, 1.0);
                ...
                MLMCMC_Bi_Uniform<pCN<NSE2dSolverIC>, NSE2dSolverIC> MLMCMCSolver(PETSC_COMM_SELF, confData.levels, 1, rank, confData.a, confData.noiseVariance, confData.randomSeed, 1.0);
                output = MLMCMCSolver.mlmcmcRun();			
