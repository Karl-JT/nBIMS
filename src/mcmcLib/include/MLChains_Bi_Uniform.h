...
template <typename samplerType, typename solverType> 
void MLChain_Uni_00<samplerType, solverType>::runInd(double QoImean[], int startLocation, std::default_random_engine* generator){
    std::ifstream indSamples("Uni_chain00_ind_samples");
    std::string line;
    std::string temp;
...
template <typename samplerType, typename solverType> 
void MLChain_Uni_0i<samplerType, solverType>::runInd(double QoImean[], int startLocation, int l, std::default_random_engine* generator){
...
public:
    ...
    virtual void generateIndSamples(int targetSampleSize, int rank, int l, std::default_random_engine* generator);
    virtual void runInd(double QoImean[], double QoI2mean[], int startLocation, int l, std::default_random_engine* generator);
};
...
template <typename samplerType, typename solverType> 
void MLChain_Uni_i0Upper<samplerType, solverType>::runInd(double A1mean[], double A2mean[], int startLocation, int l, std::default_random_engine* generator)
{
...
public:
	...
	virtual void updateQoI();
    virtual void generateIndSamples(int targetSampleSize, int rank, int l, std::default_random_engine* generator);
    virtual void runInd(double A0mean[], int startLocation, int l, std::default_random_engine* generator);
};
...
template <typename samplerType, typename solverType> 
void MLChain_Uni_i0Lower<samplerType, solverType>::runInd(double A0mean[], int startLocation, int l, std::default_random_engine* generator)
{
    std::string samplesCSV="Uni_chain";
    samplesCSV.append(std::to_string(l));
...
public:
	...
	virtual void runInd(double A0mean[], int startLocation, int l1, int l2, std::default_random_engine* generator);
};
...
template <typename samplerType, typename solverType> 
void MLChain_Uni_ijLower<samplerType, solverType>::runInd(double A0mean[], int startLocation, int l1, int l2, std::default_random_engine* generator)
{
    std::string samplesCSV="Uni_chain";
...
public:
	...
	virtual void run(double QoImean[], double QoI2mean[], std::default_random_engine* generator);
    virtual void generateIndSamples(int targetSampleSize, int rank, int l1, int l2, std::default_random_engine* generator);
	virtual void runInd(double A1mean[], double A2mean[], int startLocation, int l1, int l2, std::default_random_engine* generator);
};
...
template <typename samplerType, typename solverType> 
void MLChain_Uni_ijUpper<samplerType, solverType>::runInd(double A1mean[], double A2mean[], int startLocation, int l1, int l2, std::default_random_engine* generator)
{
    std::string samplesCSV="Uni_chain";
    samplesCSV.append(std::to_string(l1));
    samplesCSV.append(std::to_string(l2));
