...
int main(int argc, char* argv[])
{
	...
	// PetscOptionsSetValue(NULL, "-ksp_type", "fgmres");
	// PetscOptionsSetValue(NULL, "-pc_fieldsplit_type", "symmetric_multiplicative");
	// PetscOptionsSetValue(NULL, "-fieldsplit_u_pc_type", "gamg");
	// PetscOptionsSetValue(NULL, "-fieldsplit_u_ksp_type", "preonly");
	// PetscOptionsSetValue(NULL, "-fieldsplit_p_pc_type", "jacobi");
	// PetscOptionsSetValue(NULL, "-fieldsplit_p_ksp_type", "preonly");
	...
	switch (confData.task){
        ...
        {
            stokes2dpenaltySolver singleForwardSolver(PETSC_COMM_SELF, confData.levels, confData.num_term,confData.noiseVariance);
            singleForwardSolver.samples[0]=confData.rand_coef[0];
            singleForwardSolver.samples[1]=confData.rand_coef[1];
        ...
        case 2: //MLMCMC estimation
        {
            ...
            if (confData.parallelChain == 1){
                ...
                MLMCMC_Bi_Uniform<pCN<stokes2dpenaltySolver>, stokes2dpenaltySolver> MLMCMCSolver(PSubComm, confData.levels, confData.num_term, color, confData.a, confData.noiseVariance, confData.randomSeed, 1.0);
                output = MLMCMCSolver.mlmcmcRun();

                //MLMCMC_Bi<pCN<stokes2dpenaltySolver>, stokes2dpenaltySolver> MLMCMCSolver(PSubComm, confData.levels, confData.num_term, color, confData.a, confData.noiseVariance, confData.randomSeed, confData.pCNstep);
                //output = MLMCMCSolver.mlmcmcRun();
                ...
                MLMCMC_Bi_Uniform<pCN<stokes2dpenaltySolver>, stokes2dpenaltySolver> MLMCMCSolver(PETSC_COMM_SELF, confData.levels, confData.num_term, rank, confData.a, confData.noiseVariance, confData.randomSeed, 1.0);
                output = MLMCMCSolver.mlmcmcRun();			

                //MLMCMC_Bi<pCN<stokes2dpenaltySolver>, stokes2dpenaltySolver> MLMCMCSolver(PETSC_COMM_SELF, confData.levels, confData.num_term, rank, confData.a, confData.noiseVariance, confData.randomSeed, confData.pCNstep);
                //output = MLMCMCSolver.mlmcmcRun();
                std::cout << output << std::endl;
