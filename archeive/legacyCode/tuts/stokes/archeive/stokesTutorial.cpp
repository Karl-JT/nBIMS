...
int main(int argc, char* argv[]){
	...
	double randomSeed = std::stod(value[num_term+8]);
	...
	if (task == 2){
		double output;
		//MLMCMC_Bi_Uniform<pCN<stokesSolver>, stokesSolver> MLMCMCSolver(levels, 1, randomSeed+rank, a, noiseVariance, 1.0);
		//output = MLMCMCSolver.mlmcmcRun();

		MLMCMC_Bi<pCN<stokesSolver>, stokesSolver> MLMCMCSolver(levels, 1, randomSeed+rank, a, noiseVariance, 1.0);
		output = MLMCMCSolver.mlmcmcRun();
